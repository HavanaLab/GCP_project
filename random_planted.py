...
from gc_utils import is_k_color, find_k_coloring
...
def create_planted(n=1000, k=3, p=0.5):
    ...
    while len(same) == 0:
        ...
        # adj_matrix[:,5] = adj_matrix[:,4] = adj_matrix[5,:] = adj_matrix[4,:]
        # adj_matrix[4,6] = adj_matrix[6,4] = 1
        # adj_matrix[4,7] = adj_matrix[7,4] = 0
        # adj_matrix[5, 6] = adj_matrix[6, 5] = 0
        # adj_matrix[5, 7] = adj_matrix[7, 5] = 1
