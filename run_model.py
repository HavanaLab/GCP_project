...
if __name__ == '__main__':
    ...
    parser.add_argument('--graph_dir', default='/home/dov/openu/Project/pytorch_GNN/GCP_project/adversarial-training-final_data')
    ...
    opt = torch.optim.Adam(gcp.parameters(), lr=0.1)
